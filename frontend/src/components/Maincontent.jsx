    ...
    <div className="flex-grow p-6 bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-8 text-white mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl font-bold mb-4">ยินดีต้อนรับ! STD_01</h1>
          <p className="text-lg mb-6 text-blue-100">
            ระบบบันทึกข้อมูลนัดหมายการรักษาออนไลน์ที่ช่วยให้คุณ<br />
            สามารถบันทึกข้อมูลการรักษาได้อย่างง่ายดายและรวดเร็ว
            และสามารถค้นหาข้อมูลผู้ป่วยได้อย่างสะดวกและรวดเร็ว
          </p>
          <button className=" bg-cyan-500 shadow-xl shadow-cyan-500/50 hover:bg-cyan-400 text-white px-6 py-3 rounded-full font-medium
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">นัดหมายล่าสุด</h2>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-4">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <div>
                <p className="font-medium text-gray-900">นัดหมาย พบหาเพื่อวิเคราะห์ POC</p>
                <p className="text-sm text-gray-500">วันที่ 5 ธ.ค. 2568 เวลา 10:00 น.</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="font-medium text-gray-900">นัดหมาย พบหาเพื่อวิเคราะห์ P11</p>
                <p className="text-sm text-gray-500">วันที่ 7 ธ.ค. 2568 เวลา 14:00 น.</p>
              </div>
            </div>
