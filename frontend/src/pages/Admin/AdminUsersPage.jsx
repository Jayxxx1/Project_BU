          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              {/*
                ...
                When editing a student user, restrict the studentId field to numbers only (up to 10 digits).
                Strip all non-digit characters on change and cap at 10.  This prevents malicious input and
                mirrors the validation in the create user form.  We also set inputMode and pattern
                attributes to hint numeric keyboards on mobile devices.
